...
class WidgetsModels {
  ...
  static InputDecoration customdecoration1(BorderSide enablebs,
      BorderRadius enablebr, BorderSide bs, BorderRadius br, Widget varprefix) {
  ...
  static Column customTTF_title(
      String vartitle,
      TextEditingController varcontroller,
      var varonsave,
      TextInputType varkeybordtype,
      TextEditingController vali,
      Widget varprefix) {
    return Column(
      children: [
        Container_widget(
            ...
            Text(
              ...
              style: customtextstyle(
                  ColorPalette.SH_Grey900, 17, FontWeight.w400, 'Roboto'),
            )),
        Container_widget(
            null,
            80,
            ...
            customTFF(
                varcontroller,
                customtextstyle(
                    Colors.black, 18, FontWeight.w200, 'Montserrat'),
                ...
                customdecoration1(
                    ...
                    BorderSide(color: ColorPalette.Primary_Color_Light),
                    BorderRadius.circular(10),
                    varprefix)))
      ],
    );
