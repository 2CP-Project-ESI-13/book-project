class Feildvalidator{
  ...
  else{ if (value!.length == 0) {return "Email is Required";}
        else if (!_isEmailValid(value)) {return "Must be a valid email address";}
  }
}
static String? validatepassword(String? value) {
  if (value==null){return null;}
  else{ if (value!.length == 0) {return "password is Required";}
        else if (!_ispasswordValid(value)) {return "Must be a valid email password";}
  }
}
